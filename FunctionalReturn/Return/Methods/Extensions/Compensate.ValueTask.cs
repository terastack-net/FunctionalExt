...
namespace FunctionalReturn.ValueTasks
{
    public static partial class ResultExtensions
    {
        ...
        public static async ValueTask<UnitReturn<E>> Compensate<E>(this ValueTask<Return> resultTask, Func<Exception, ValueTask<UnitReturn<E>>> valueTask)
        {
            var result = await resultTask;
            return await result.Compensate(valueTask);
        }
        ...
        public static async ValueTask<Return> Compensate<E>(this ValueTask<UnitReturn<E>> resultTask, Func<E, ValueTask<Return>> valueTask)
        {
            var result = await resultTask;
            return await result.Compensate(valueTask);
        }

        public static async ValueTask<UnitReturn<E2>> Compensate<E, E2>(this ValueTask<UnitReturn<E>> resultTask, Func<E, ValueTask<UnitReturn<E2>>> valueTask)
        {
            var result = await resultTask;
            return await result.Compensate(valueTask);
        }
        ...
        public static async ValueTask<UnitReturn<E2>> Compensate<T, E, E2>(this ValueTask<Return<T, E>> resultTask, Func<E, ValueTask<UnitReturn<E2>>> valueTask)
        {
            var result = await resultTask;
            return await result.Compensate(valueTask);
        }
