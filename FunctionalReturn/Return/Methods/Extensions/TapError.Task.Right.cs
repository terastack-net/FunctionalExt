...
namespace FunctionalReturn
{
    public static partial class ResultExtensions
    {
        ...
        ///     Executes the given action if the calling result is a failure. Returns the calling result.
        /// </summary>
        public static async Task<UnitReturn<E>> TapError<E>(this UnitReturn<E> result, Func<Task> func)
        {
            if (result.IsFailure)
            {
                await func().DefaultAwait();
        ...
        ///     Executes the given action if the calling result is a failure. Returns the calling result.
        /// </summary>
        public static async Task<UnitReturn<E>> TapError<E>(this UnitReturn<E> result, Func<E, Task> func)
        {
            if (result.IsFailure)
            {
                await func(result.Error).DefaultAwait();
