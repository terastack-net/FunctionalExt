...
namespace FunctionalReturn.ValueTasks
{
    public static partial class ResultExtensions
    {
        ...
        ///     Executes the given action if the calling result is a failure and condition is true. Returns the calling result.
        /// </summary>
        public static ValueTask<UnitReturn<E>> TapErrorIf<E>(this ValueTask<UnitReturn<E>> resultTask, bool condition, Func<ValueTask> valueTask)
        {
            if (condition)
            {
                return resultTask.TapError(valueTask);
        ...
        ///     Executes the given action if the calling result is a failure and condition is true. Returns the calling result.
        /// </summary>
        public static ValueTask<UnitReturn<E>> TapErrorIf<E>(this ValueTask<UnitReturn<E>> resultTask, bool condition, Func<E, ValueTask> valueTask)
        {
            if (condition)
            {
                return resultTask.TapError(valueTask);
        ...
        ///     Executes the given action if the calling result is a failure and condition is true. Returns the calling result.
        /// </summary>
        public static async ValueTask<UnitReturn<E>> TapErrorIf<E>(this ValueTask<UnitReturn<E>> resultTask, Func<E, bool> predicate, Func<ValueTask> valueTask)
        {
        ...
        ///     Executes the given action if the calling result is a failure and condition is true. Returns the calling result.
        /// </summary>
        public static async ValueTask<UnitReturn<E>> TapErrorIf<E>(this ValueTask<UnitReturn<E>> resultTask, Func<E, bool> predicate, Func<E, ValueTask> valueTask)
        {
            UnitReturn<E> result = await resultTask;
