...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    public class MapErrorTests : TestBase
    {
        ...
        public void MapError_returns_success()
        {
            ...
            Return actual = result.MapError(error =>
            {
                invocations++;
                return $"{error} {error}";
            });
        ...
        public void MapError_T_returns_success()
        {
            ...
            Return<T> actual = result.MapError(error =>
            {
                invocations++;
                return $"{error} {error}";
            });
        ...
        public void MapError_T_returns_success_with_context()
        {
            ...
            Return<T> actual = result.MapError(
                (error, context) =>
                {
                    context.Should().Be(ContextMessage);
                    invocations++;
        ...
        public void MapError_T_E_returns_success()
        {
            ...
            Return<T, E> actual = result.MapError(_ =>
            {
                invocations++;
                return E.Value;
            });
        ...
        public void MapError_T_E_returns_success_with_context()
        {
            ...
            Return<T, E> actual = result.MapError(
                (_, context) =>
                {
                    context.Should().Be(ContextMessage);
                    invocations++;
        ...
        public void MapError_T_E_returns_new_failure()
        {
            ...
            Return<T, E> actual = result.MapError(error =>
            {
        ...
        public void MapError_T_E_string_returns_success()
        {
            ...
            Return<T> actual = result.MapError(_ =>
            {
                invocations++;
                return "error";
            });
        ...
        public void MapError_T_E_E2_returns_success()
        {
            ...
            Return<T, E2> actual = result.MapError(_ =>
            {
                invocations++;
                return E2.Value;
            });
        ...
        public void MapError_T_E_E2_returns_success_with_context()
        {
            ...
            Return<T, E2> actual = result.MapError(
                (_, context) =>
                {
                    context.Should().Be(ContextMessage);
                    invocations++;
        ...
        public void MapError_T_E_E2_returns_new_failure()
        {
            ...
            Return<T, E2> actual = result.MapError(error =>
            {
                error.Should().Be(E.Value);
                invocations++;
                return E2.Value;
