...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    public class FinallyTests_ValueTask_Right : FinallyTestsBase
    {
        ...
        [InlineData(true)]
        [InlineData(false)]
        public async Task Finally_ValueTask_Right_result_T_E_returns_K(bool isSuccess)
        {
        ...
        [Fact]
        public async Task Finally_ValueTask_Right_UnitResult_E_executes_on_success_returns_K()
        {
        ...
        [Fact]
        public async Task Finally_ValueTask_Right_UnitResult_E_executes_on_failure_returns_K() {
