...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    public class MapIfTests_Task_Right : MapIfTestsBase
    {
        ...
        )
        {
            ...
            Return<T> returned = await result.MapIf(condition, GetTaskAction());
        ...
        )
        {
            ...
            Return<T, E> returned = await result.MapIf(condition, GetTaskAction());
        ...
        )
        {
            ...
            Return<T> returned = await result.MapIf(GetValuePredicate(condition), GetTaskAction());
        ...
        )
        {
            ...
            Return<T, E> returned = await result.MapIf(
        ...
        )
        {
            ...
            Return<T> returned = await result.MapIf(
                condition,
                async (value, context) =>
                {
