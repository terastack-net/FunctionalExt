...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    public class BindIfTests_ValueTask : BindIfTestsBase
    {
        ...
        {
            ValueTask<Return> resultTask = Return.SuccessIf(isSuccess, ErrorMessage).AsValueTask();

            Return returned = await resultTask.BindIf(condition, GetValueTaskAction(isSuccessAction));
        ...
        {
            ValueTask<Return<T>> resultTask = Return.SuccessIf(isSuccess, T.Value, ErrorMessage).AsValueTask();

            Return<T> returned = await resultTask.BindIf(condition, GetValueTaskValueAction(isSuccessAction));
        ...
        {
            ValueTask<Return<T, E>> resultTask = Return.SuccessIf(isSuccess, T.Value, E.Value).AsValueTask();

            Return<T, E> returned = await resultTask.BindIf(condition, GetValueTaskValueErrorAction(isSuccessAction));
        ...
        public async Task BindIf_ValueTask_computes_predicate_executes_func_conditionally_and_returns_new_result(bool isSuccess, bool condition, bool isSuccessAction)
        {
            ...
            Return returned = await resultTask.BindIf(GetPredicate(condition), GetValueTaskAction(isSuccessAction));
        ...
        public async Task BindIf_ValueTask_computes_predicate_T_executes_func_conditionally_and_returns_new_result(bool isSuccess, bool condition, bool isSuccessAction)
        {
            ...
            Return<T> returned = await resultTask.BindIf(GetValuePredicate(condition), GetValueTaskValueAction(isSuccessAction));
        ...
        public async Task BindIf_ValueTask_computes_predicate_T_E_executes_func_conditionally_and_returns_new_result(bool isSuccess, bool condition, bool isSuccessAction)
        {
            ...
            Return<T, E> returned = await resultTask.BindIf(GetValuePredicate(condition), GetValueTaskValueErrorAction(isSuccessAction));
