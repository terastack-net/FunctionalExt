...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    public class EnsureTests_ValueTask_Left
    {
        ...
        {
            var result = Return.Failure<string>("initial error message").AsCompletedValueTask();
        ...
        {
            var tResult = Return.Failure<string>("initial error message").AsCompletedValueTask();
        ...
        {
            var tResult = Return.Success("initial ok").AsCompletedValueTask();
        ...
        {
            var tResult = Return.Success<int?>(null).AsCompletedValueTask();
        ...
        {
            var tResult = Return.Success("").AsCompletedValueTask();
