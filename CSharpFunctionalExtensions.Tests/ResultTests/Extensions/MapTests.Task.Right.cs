...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    public class MapTests_Task_Right : MapTestsBase
    {
        ...
        [Fact]
        public async Task Map_Task_Right_executes_on_failure_returns_new_failure()
        {
        ...
        [Fact]
        public async Task Map_Task_Right_T_executes_on_success_returns_new_success()
        {
        ...
        [Fact]
        public async Task Map_Task_Right_T_executes_on_failure_returns_new_failure()
        {
        ...
        [Fact]
        public async Task Map_Task_Right_T_E_executes_on_success_returns_new_success()
        {
        ...
        [Fact]
        public async Task Map_Task_Right_T_E_executes_on_failure_returns_new_failure()
        {
        ...
        [Fact]
        public async Task Map_Task_Right_UnitResult_E_executes_on_success_returns_success()
        {
        ...
        [Fact]
        public async Task Map_Task_Right_UnitResult_E_executes_on_failure_returns_failure()
        {
