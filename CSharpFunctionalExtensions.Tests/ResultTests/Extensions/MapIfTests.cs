...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    public class MapIfTests : MapIfTestsBase
    {
        ...
        public void MapIf_T_executes_func_conditionally_and_returns_new_result(
            bool isSuccess,
            bool condition
        )
        {
        ...
        [InlineData(false, true)]
        [InlineData(false, false)]
        public void MapIf_T_E_executes_func_conditionally_and_returns_new_result(
            bool isSuccess,
            bool condition
        )
        {
        ...
        [InlineData(false, true)]
        [InlineData(false, false)]
        public void MapIf_computes_predicate_T_executes_func_conditionally_and_returns_new_result(
            bool isSuccess,
            bool condition
        )
        {
        ...
        [InlineData(false, true)]
        [InlineData(false, false)]
        public void MapIf_computes_predicate_T_E_executes_func_conditionally_and_returns_new_result(
            bool isSuccess,
            bool condition
        )
        {
        ...
        [InlineData(false, true)]
        [InlineData(false, false)]
        public void MapIf_T_with_context_executes_func_conditionally_and_passes_context(
            bool isSuccess,
            bool condition
        )
        {
        ...
        [InlineData(false, true)]
        [InlineData(false, false)]
        public void MapIf_T_E_with_context_executes_func_conditionally_and_passes_context(
            bool isSuccess,
            bool condition
        )
        {
        ...
        [InlineData(false, true)]
        [InlineData(false, false)]
        public void MapIf_computes_predicate_T_with_context_executes_func_conditionally_and_passes_context(
            bool isSuccess,
            bool condition
        )
        {
        ...
        [InlineData(false, true)]
        [InlineData(false, false)]
        public void MapIf_computes_predicate_T_E_with_context_executes_func_conditionally_and_passes_context(
            bool isSuccess,
            bool condition
        )
        {
