...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Methods.Try
{
    ...
    public class TryTestBaseTestsTask : TryTestBaseTask
    {
        ...
        {
            var result = await Return.Try(Func_Task);
        ...
        {
            var result = await Return.Try(Throwing_Func_Task);
        ...
        {
            var result = await Return.Try(Throwing_Func_Task, ErrorHandler);
        ...
        {
            var defaultTryErrorHandler = Return.Configuration.DefaultTryErrorHandler;
            Return.Configuration.DefaultTryErrorHandler = ErrorHandler;
            var result = await Return.Try(Throwing_Func_Task);
            Return.Configuration.DefaultTryErrorHandler = defaultTryErrorHandler;
        ...
        {
            var result = await Return.Try(Func_Task_T);
        ...
        {
            var result = await Return.Try(Throwing_Func_Task_T);
        ...
        {
            var result = await Return.Try(Throwing_Func_Task_T, ErrorHandler);
        ...
        {
            var result = await Return.Try(Func_Task_T, ErrorHandler_E);
        ...
        {
            var result = await Return.Try(Throwing_Func_Task_T, ErrorHandler_E);
