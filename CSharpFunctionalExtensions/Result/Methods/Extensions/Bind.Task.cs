...
namespace FunctionalReturn
{
    public static partial class AsyncResultExtensionsBothOperands
    {
        ...
        ///     Selects result from the return value of a given function. If the calling Result is a failure, a new failure result is returned instead.
        /// </summary>
        public static async Task<UnitReturn<E>> Bind<E>(this Task<UnitReturn<E>> resultTask, Func<Task<UnitReturn<E>>> func)
        {
        ...
        ///     Selects result from the return value of a given function. If the calling Result is a failure, a new failure result is returned instead.
        /// </summary>
        public static async Task<Return<T, E>> Bind<T, E>(this Task<UnitReturn<E>> resultTask, Func<Task<Return<T, E>>> func)
        {
            UnitReturn<E> result = await resultTask.DefaultAwait();
            return await result.Bind(func).DefaultAwait();
        }
        ...
        ///     Selects result from the return value of a given function. If the calling Result is a failure, a new failure result is returned instead.
        /// </summary>
        public static async Task<UnitReturn<E>> Bind<T, E>(this Task<Return<T, E>> resultTask, Func<T, Task<UnitReturn<E>>> func)
        {
            Return<T, E> result = await resultTask.DefaultAwait();
            return await result.Bind(func).DefaultAwait();
        }
